...
const PasswordCriteria = ({password}) => {
    const criteria = [
        {label: "At least a minimum of 6 characters", met: password.length >= 6},
        {label: "Contains an uppercase", met: /[A-Z]/.test(password)},
        {label: "Contains a lowercase", met: /[a-z]/.test(password)},
